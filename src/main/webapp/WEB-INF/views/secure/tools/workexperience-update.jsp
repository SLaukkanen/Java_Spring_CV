...
<html lang="en">
<head>
  <title><spring:message code="work.update"/></title>
  <meta charset="utf-8">
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <form:form modelAttribute="workexperience" action="../save_update" method="post">
	<fieldset>
		<legend><spring:message code="changeinfo" /></legend>
				...
				<p>
					...
					<form:input value="${workexperience.workplace}" path="workplace" cssErrorClass="ErrorInput"/> <form:errors path="workplace" cssClass="ErrorTxt"/>		
				</p>
				<p>	
					<form:label path="position"><spring:message code="work.position" /></form:label>
					<form:input value="${workexperience.position}" path="position" cssErrorClass="ErrorInput"/> <form:errors path="position" cssClass="ErrorTxt"/>	
				</p>
				<p>
					<form:label	path="startDate"><spring:message code="work.startdate" /></form:label>
					<form:input value="${workexperience.startDate}" path="startDate" cssErrorClass="ErrorInput"/> <form:errors path="startDate" cssClass="ErrorTxt"/>		
				</p>
				<p>	
					<form:label path="finishDate"><spring:message code="work.finishdate" /></form:label>
					<form:input value="${workexperience.finishDate}" path="finishDate" cssErrorClass="ErrorInput"/> <form:errors path="finishDate" cssClass="ErrorTxt"/>	
				</p>
				<p>	
					<form:label path="description"><spring:message code="description" /></form:label>
					<form:input value="${workexperience.description}" path="description" cssErrorClass="ErrorInput"/> <form:errors path="description" cssClass="ErrorTxt"/>	
				</p>
