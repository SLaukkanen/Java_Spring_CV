...
<html lang="en">
<head>
  <title><spring:message code="edu.new"/></title>
  <meta charset="utf-8">
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <form:form modelAttribute="education" action="./save_new" method="post">
	<fieldset>
		<legend><spring:message code="createnew" /></legend>
				...
				<p>
					...
					<form:input path="school" cssErrorClass="ErrorInput"/> <form:errors path="school" cssClass="ErrorTxt"/>		
				</p>
				<p>	
					<form:label path="degree"><spring:message code="edu.degree" /></form:label>
					<form:input path="degree" cssErrorClass="ErrorInput"/> <form:errors path="degree" cssClass="ErrorTxt"/>	
				</p>
				<p>
					<form:label	path="major"><spring:message code="edu.major" /></form:label>
					<form:input path="major" cssErrorClass="ErrorInput"/> <form:errors path="major" cssClass="ErrorTxt"/>		
				</p>
				<p>	
					<form:label path="minors"><spring:message code="edu.minors" /></form:label>
					<form:input path="minors" cssErrorClass="ErrorInput"/> <form:errors path="minors" cssClass="ErrorTxt"/>	
				</p>
				<p>	
					<form:label path="startYear"><spring:message code="edu.startyear" /></form:label>
					<form:input path="startYear" cssErrorClass="ErrorInput"/> <form:errors path="startYear" cssClass="ErrorTxt"/>	
				</p>
				<p>	
					<form:label path="finishYear"><spring:message code="edu.finishyear" /></form:label>
					<form:input path="finishYear" cssErrorClass="ErrorInput"/> <form:errors path="finishYear" cssClass="ErrorTxt"/>	
				</p>
				<p>	
					<form:label path="dateGraduation"><spring:message code="edu.dategraduation" /></form:label><br/>
					<form:input path="dateGraduation" cssErrorClass="ErrorInput"/> <form:errors path="dateGraduation" cssClass="ErrorTxt"/>	
				</p>
				<p>	
