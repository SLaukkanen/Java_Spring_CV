...
<html>
<head>
  <title><spring:message code="work"/></title>
  <meta charset="utf-8">
   ...
   <div class="row content">   
    ...
    <div class="col-sm-8 text-left"> 
       <c:forEach items="${workexperience}" var="wExp">
     	...
     	<p>
       	<form:form modelAttribute="workexperience" action="work/update/${wExp.id}" method="get">
       		<button type="submit"><spring:message code="update"/></button>
       	</form:form>
       	
       	<form:form modelAttribute="workexperience" action="work/delete/${wExp.id}" method="get">
      ...
      <p>
      	<form:form modelAttribute="workexperience" action="work/new" method="get">
